...
const LogIn: React.FC = () => {
  ...
  return (
    <>
      <Metadata
        title="Login | Retro Manager"
        description="Log into the Retro Manager and start giving your standup report now!"
        keywords="Login, Log into Retro Manager, Give standup report, Give daily standup report"
      />
