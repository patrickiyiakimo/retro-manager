    ...
    <div className="pt-56 pb-56">
      <div className="mx-20">
        ...
        <div className="my-6 flex items-center justify-center">
          <button className="rounded-md bg-blue-700 px-7 py-3 font-bold text-white hover:bg-blue-600">
            Start Retro
          </button>
          <button className="mx-4 rounded-md bg-gray-400 px-7 py-3 font-bold text-white hover:bg-gray-500">
            Create Team
          </button>
        </div>
      </div>
